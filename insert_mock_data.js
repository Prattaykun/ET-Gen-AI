...
// Generate dummy embeddings (an array of 384 zeros or random floats)
...
const mockArticles = [
  ...
  },
  {
    ...
    image_url: "https://images.unsplash.com/photo-1516322073320-80bd1db5c102?auto=format&fit=crop&q=80&w=800",
    embedding: generateDummyEmbedding()
  },
  {
    id: "4",
    ...
    image_url: "https://images.unsplash.com/photo-1518173946687-a4c8892bbd9f?auto=format&fit=crop&q=80&w=800",
    embedding: generateDummyEmbedding()
  },
  {
    id: "5",
...
async function insert() {
  ...
  if (error) {
      ...
      console.log("Successfully inserted mock data with embeddings.");
  }
}
